Title: Create conversation message | Genie API | REST API reference

URL Source: https://docs.databricks.com/api/workspace/genie/createmessage
...
[`space_id`](https://docs.databricks.com/api/workspace/genie/createmessage#space_id)uuid Required

Example`"e1ef34712a29169db030324fd0e1df5f"`

The ID associated with the Genie space where the conversation is started.

[`conversation_id`](https://docs.databricks.com/api/workspace/genie/createmessage#conversation_id)uuid Required
...
[`content`](https://docs.databricks.com/api/workspace/genie/createmessage#content)string Required
...
[`attachments`](https://docs.databricks.com/api/workspace/genie/createmessage#attachments)Array of object

AI-generated response to the message

Array [

[`attachment_id`](https://docs.databricks.com/api/workspace/genie/createmessage#attachments-attachment_id)string

Attachment ID

[`query`](https://docs.databricks.com/api/workspace/genie/createmessage#attachments-query)object

Query Attachment if Genie responds with a SQL query

[`suggested_questions`](https://docs.databricks.com/api/workspace/genie/createmessage#attachments-suggested_questions)object

Follow-up questions suggested by Genie

[`text`](https://docs.databricks.com/api/workspace/genie/createmessage#attachments-text)object

Text Attachment if Genie responds with text This also contains the final summary when available.

 ]

[`content`](https://docs.databricks.com/api/workspace/genie/createmessage#content)string

Example`"Biggest open opportunities"`

User message content

[`conversation_id`](https://docs.databricks.com/api/workspace/genie/createmessage#conversation_id)uuid

Example`"e1ef34712a29169db030324fd0e1df5f"`

Conversation ID

[`created_timestamp`](https://docs.databricks.com/api/workspace/genie/createmessage#created_timestamp)int64

Timestamp when the message was created

[`error`](https://docs.databricks.com/api/workspace/genie/createmessage#error)object

Error message if Genie failed to respond to the message

[`error`](https://docs.databricks.com/api/workspace/genie/createmessage#error-error)string

[`type`](https://docs.databricks.com/api/workspace/genie/createmessage#error-type)string
...
[`id`](https://docs.databricks.com/api/workspace/genie/createmessage#id)uuid
...
[`last_updated_timestamp`](https://docs.databricks.com/api/workspace/genie/createmessage#last_updated_timestamp)int64

Timestamp when the message was last updated

[`message_id`](https://docs.databricks.com/api/workspace/genie/createmessage#message_id)uuid

Example`"e1ef34712a29169db030324fd0e1df5f"`

Message ID

[`query_result`](https://docs.databricks.com/api/workspace/genie/createmessage#query_result)object
...
[`is_truncated`](https://docs.databricks.com/api/workspace/genie/createmessage#query_result-is_truncated)boolean

If result is truncated

[`row_count`](https://docs.databricks.com/api/workspace/genie/createmessage#query_result-row_count)int64

Row count of the result

[`statement_id`](https://docs.databricks.com/api/workspace/genie/createmessage#query_result-statement_id)string
...
[`statement_id_signature`](https://docs.databricks.com/api/workspace/genie/createmessage#query_result-statement_id_signature)string

JWT corresponding to the statement contained in this result

[`space_id`](https://docs.databricks.com/api/workspace/genie/createmessage#space_id)uuid

Example`"e1ef34712a29169db030324fd0e1df5f"`

Genie space ID

[`status`](https://docs.databricks.com/api/workspace/genie/createmessage#status)string
...
[`user_id`](https://docs.databricks.com/api/workspace/genie/createmessage#user_id)int64

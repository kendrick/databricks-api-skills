Title: Create Genie Space | Genie API | REST API reference

URL Source: https://docs.databricks.com/api/workspace/genie/createspace
...
[`description`](https://docs.databricks.com/api/workspace/genie/createspace#description)string

Optional description

[`parent_path`](https://docs.databricks.com/api/workspace/genie/createspace#parent_path)string

Parent folder path where the space will be registered

[`serialized_space`](https://docs.databricks.com/api/workspace/genie/createspace#serialized_space)required string

The contents of the Genie Space in serialized string form. Use the [Get Genie Space](https://docs.databricks.com/api/workspace/genie/getspace) API to retrieve an example response, which includes the `serialized_space` field. This field provides the structure of the JSON string that represents the space's layout and components.

[`title`](https://docs.databricks.com/api/workspace/genie/createspace#title)string

Optional title override

[`warehouse_id`](https://docs.databricks.com/api/workspace/genie/createspace#warehouse_id)required string
...
[`serialized_space`](https://docs.databricks.com/api/workspace/genie/createspace#serialized_space)string
...
[`space_id`](https://docs.databricks.com/api/workspace/genie/createspace#space_id)uuid
...
[`warehouse_id`](https://docs.databricks.com/api/workspace/genie/createspace#warehouse_id)string

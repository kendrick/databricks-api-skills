Title: Get message attachment SQL query result | Genie API | REST API reference

URL Source: https://docs.databricks.com/api/workspace/genie/getmessageattachmentqueryresult
...
[`space_id`](https://docs.databricks.com/api/workspace/genie/getmessageattachmentqueryresult#space_id)required uuid

Example`"e1ef34712a29169db030324fd0e1df5f"`

Genie space ID

[`conversation_id`](https://docs.databricks.com/api/workspace/genie/getmessageattachmentqueryresult#conversation_id)required uuid

Example`"e1ef34712a29169db030324fd0e1df5f"`

Conversation ID

[`message_id`](https://docs.databricks.com/api/workspace/genie/getmessageattachmentqueryresult#message_id)required uuid

Example`"e1ef34712a29169db030324fd0e1df5f"`

Message ID

[`attachment_id`](https://docs.databricks.com/api/workspace/genie/getmessageattachmentqueryresult#attachment_id)required uuid
...
[`statement_response`](https://docs.databricks.com/api/workspace/genie/getmessageattachmentqueryresult#statement_response)object
...
[`manifest`](https://docs.databricks.com/api/workspace/genie/getmessageattachmentqueryresult#statement_response-manifest)object

The result manifest provides schema and metadata for the result set.

[`result`](https://docs.databricks.com/api/workspace/genie/getmessageattachmentqueryresult#statement_response-result)object
...
[`statement_id`](https://docs.databricks.com/api/workspace/genie/getmessageattachmentqueryresult#statement_response-statement_id)string
...
[`status`](https://docs.databricks.com/api/workspace/genie/getmessageattachmentqueryresult#statement_response-status)object

Title: Update Genie Space | Genie API | REST API reference

URL Source: https://docs.databricks.com/api/workspace/genie/updatespace
...
[`space_id`](https://docs.databricks.com/api/workspace/genie/updatespace#space_id)required string
...
The contents of the Genie Space in serialized string form (full replacement). Use the [Get Genie Space](https://docs.databricks.com/api/workspace/genie/getspace) API to retrieve an example response, which includes the `serialized_space` field. This field provides the structure of the JSON string that represents the space's layout and components.

[`title`](https://docs.databricks.com/api/workspace/genie/updatespace#title)string

Optional title override

[`warehouse_id`](https://docs.databricks.com/api/workspace/genie/updatespace#warehouse_id)string
...
[`space_id`](https://docs.databricks.com/api/workspace/genie/updatespace#space_id)uuid

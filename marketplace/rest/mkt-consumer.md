...
```
Optional query: `page_size` (int32), `page_token`, `assets` (array), `categories` (array), `tags` (array of `{tag_name, tag_values}`), `is_free`, `is_private_exchange`, `is_staff_pick`, `provider_ids` (array).
